export default async function handler(req,res){
  ...
  const video='/api/video?i=0&v=20260906-mobile03';
  ...
  html=html.replace(/camera-recovery\.js\?v=20260904-camera02/g,'camera-recovery.js?v=20260906-camera-root03');

  const mobileFix=`<script id="ktNewAddressVideoFix">(function(){
    var VERSION='20260906-mobile03';
  ...
  res.setHeader('x-ktalk-root-fix','4');
  res.send(html);
}
